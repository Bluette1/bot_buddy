...
# @pytest.mark.asyncio
# async def test_ping_command(mock_ctx):
#     # Set a realistic latency value for testing
#     bot.latency = 0.123
...
#     mock_ctx.send.assert_called_once_with("Pong! Latency is 123ms")
...
@pytest.mark.asyncio
async def test_on_member_join(mocker, mock_messages_collection):
    ...
    # Set up the message in the collection
